...
declare module '#imports' {
  ...
  export { hasEnoughNewWords, countWords, isDuplicate, markSeen } from '../utils/detection';
  export { MessageToSW, MessageToContent, TermCard } from '../utils/messages';
  export { parseTimedText, getTranscriptContext, selectBestTrack, Caption, TimedTextTrack } from '../utils/timedtext';
}
